...
namespace AppTracker.ServiceLayer.CommonObjectsService
{
    public class ApplcationsReportData
    {
        ...
        public List<OracleModel> GetReportsForApplication(int? parmAppID)
        {
            ...
            try
            {
                ...
                var match = matchingReports.AsEnumerable()
                    .ToList();
        ...
        public List<OracleModel> ReturnAllUserReports(string blazerid)
        {
            ...
            //{
            //    combinedReports.AddRange(_oracleConnection.GetMatchingReports(id));
